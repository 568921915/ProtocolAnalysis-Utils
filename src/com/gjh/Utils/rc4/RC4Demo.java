...
public class RC4Demo {
	public static void main(String[] args) {
		...
		try {
	        ...
	        String hexim = ByteUtils.byteArrayToHexStr(im);
	        v0 = new String(im);
